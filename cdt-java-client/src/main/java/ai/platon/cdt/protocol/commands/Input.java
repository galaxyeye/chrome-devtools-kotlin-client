...
import ai.platon.cdt.protocol.events.input.DragIntercepted;
...
import ai.platon.cdt.protocol.types.input.DispatchDragEventType;
import ai.platon.cdt.protocol.types.input.DispatchKeyEventType;
import ai.platon.cdt.protocol.types.input.DispatchMouseEventPointerType;
import ai.platon.cdt.protocol.types.input.DispatchMouseEventType;
import ai.platon.cdt.protocol.types.input.DispatchTouchEventType;
import ai.platon.cdt.protocol.types.input.DragData;
import ai.platon.cdt.protocol.types.input.EmulateTouchFromMouseEventType;
import ai.platon.cdt.protocol.types.input.GestureSourceType;
import ai.platon.cdt.protocol.types.input.MouseButton;
import ai.platon.cdt.protocol.types.input.TouchPoint;
