...
import ai.platon.cdt.protocol.events.browser.DownloadProgress;
import ai.platon.cdt.protocol.events.browser.DownloadWillBegin;
...
import ai.platon.cdt.protocol.types.browser.Bounds;
import ai.platon.cdt.protocol.types.browser.BrowserCommandId;
import ai.platon.cdt.protocol.types.browser.Histogram;
import ai.platon.cdt.protocol.types.browser.PermissionDescriptor;
import ai.platon.cdt.protocol.types.browser.PermissionSetting;
import ai.platon.cdt.protocol.types.browser.PermissionType;
import ai.platon.cdt.protocol.types.browser.SetDownloadBehaviorBehavior;
import ai.platon.cdt.protocol.types.browser.Version;
import ai.platon.cdt.protocol.types.browser.WindowForTarget;
