...
import ai.platon.cdt.kt.protocol.events.storage.InterestGroupAccessed
import ai.platon.cdt.kt.protocol.events.storage.InterestGroupAuctionEventOccurred
import ai.platon.cdt.kt.protocol.events.storage.InterestGroupAuctionNetworkRequestCreated
import ai.platon.cdt.kt.protocol.events.storage.SharedStorageAccessed
import ai.platon.cdt.kt.protocol.events.storage.SharedStorageWorkletOperationExecutionFinished
import ai.platon.cdt.kt.protocol.events.storage.StorageBucketCreatedOrUpdated
import ai.platon.cdt.kt.protocol.events.storage.StorageBucketDeleted
...
import ai.platon.cdt.kt.protocol.types.storage.RelatedWebsiteSet
import ai.platon.cdt.kt.protocol.types.storage.SharedStorageEntry
import ai.platon.cdt.kt.protocol.types.storage.SharedStorageMetadata
...
interface Storage {
  ...
  suspend fun getInterestGroupDetails(@ParamName("ownerOrigin") ownerOrigin: String, @ParamName("name") name: String): Map<String, Any?>
