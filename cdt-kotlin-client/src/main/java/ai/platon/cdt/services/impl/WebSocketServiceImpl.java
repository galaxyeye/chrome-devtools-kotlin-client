package ai.platon.cdt.services.impl;
...
import static ai.platon.cdt.services.impl.utils.WebSocketUtils.isTyrusBufferOverflowCloseReason;
import static ai.platon.cdt.services.utils.ConfigurationUtils.systemProperty;

import ai.platon.cdt.services.WebSocketService;
import ai.platon.cdt.services.exceptions.WebSocketServiceException;
import ai.platon.cdt.services.factory.WebSocketContainerFactory;
import ai.platon.cdt.services.factory.impl.DefaultWebSocketContainerFactory;
...
public class WebSocketServiceImpl implements WebSocketService {
  public static final String WEB_SOCKET_CONTAINER_FACTORY_PROPERTY =
      "ai.platon.cdt.services.config.webSocketContainerFactory";
    ...
    try {
      ...
      throw new RuntimeException(
          containerFactoryClassName
              + " does not implement ai.platon.cdt.services.factory.WebSocketContainerFactory interface.");
