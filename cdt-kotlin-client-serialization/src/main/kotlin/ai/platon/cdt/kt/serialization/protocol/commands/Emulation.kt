...
import ai.platon.cdt.kt.serialization.protocol.events.emulation.ScreenOrientationLockChanged
import ai.platon.cdt.kt.serialization.protocol.events.emulation.VirtualTimeBudgetExpired
...
import ai.platon.cdt.kt.serialization.protocol.types.emulation.DevicePosture
import ai.platon.cdt.kt.serialization.protocol.types.emulation.DisabledImageType
import ai.platon.cdt.kt.serialization.protocol.types.emulation.DisplayFeature
import ai.platon.cdt.kt.serialization.protocol.types.emulation.MediaFeature
import ai.platon.cdt.kt.serialization.protocol.types.emulation.PressureMetadata
import ai.platon.cdt.kt.serialization.protocol.types.emulation.PressureSource
import ai.platon.cdt.kt.serialization.protocol.types.emulation.PressureState
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SafeAreaInsets
import ai.platon.cdt.kt.serialization.protocol.types.emulation.ScreenInfo
import ai.platon.cdt.kt.serialization.protocol.types.emulation.ScreenOrientation
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SensorMetadata
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SensorReading
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SensorType
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SetDeviceMetricsOverrideScrollbarType
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SetEmitTouchEventsForMouseConfiguration
import ai.platon.cdt.kt.serialization.protocol.types.emulation.SetEmulatedVisionDeficiencyType
import ai.platon.cdt.kt.serialization.protocol.types.emulation.UserAgentMetadata
import ai.platon.cdt.kt.serialization.protocol.types.emulation.VirtualTimePolicy
import ai.platon.cdt.kt.serialization.protocol.types.emulation.WorkAreaInsets
