...
import ai.platon.cdt.kt.serialization.protocol.events.animation.AnimationCanceled
import ai.platon.cdt.kt.serialization.protocol.events.animation.AnimationCreated
import ai.platon.cdt.kt.serialization.protocol.events.animation.AnimationStarted
import ai.platon.cdt.kt.serialization.protocol.events.animation.AnimationUpdated
...
interface Animation {
   ...
   */
  @Returns("currentTime")
  suspend fun getCurrentTime(@ParamName("id") id: String): Double

  /**
   * Gets the playback rate of the document timeline.
   */
  @Returns("playbackRate")
  suspend fun getPlaybackRate(): Double

  /**
   * Releases a set of animations to no longer be manipulated.
   * @param animations List of animation ids to seek.
   */
  suspend fun releaseAnimations(@ParamName("animations") animations: List<String>)
  ...
  suspend fun resolveAnimation(@ParamName("animationId") animationId: String): RemoteObject
   ...
   */
  suspend fun seekAnimations(@ParamName("animations") animations: List<String>, @ParamName("currentTime") currentTime: Double)
   ...
   */
  suspend fun setPaused(@ParamName("animations") animations: List<String>, @ParamName("paused") paused: Boolean)

  /**
   * Sets the playback rate of the document timeline.
   * @param playbackRate Playback rate for animations on page
   */
  suspend fun setPlaybackRate(@ParamName("playbackRate") playbackRate: Double)
