...
import ai.platon.cdt.kt.serialization.protocol.types.input.DispatchMouseEventPointerType
import ai.platon.cdt.kt.serialization.protocol.types.input.DispatchMouseEventType
import ai.platon.cdt.kt.serialization.protocol.types.input.DispatchTouchEventType
import ai.platon.cdt.kt.serialization.protocol.types.input.DragData
import ai.platon.cdt.kt.serialization.protocol.types.input.EmulateTouchFromMouseEventType
import ai.platon.cdt.kt.serialization.protocol.types.input.GestureSourceType
import ai.platon.cdt.kt.serialization.protocol.types.input.MouseButton
import ai.platon.cdt.kt.serialization.protocol.types.input.TouchPoint
