...
import static ai.platon.cdt.definition.builder.support.protocol.builder.CommandBuilder.buildReturnClasses;
...
public class CommandBuilderTest extends EasyMockSupport {
  ...
  public void testBuildCommandWithMethodWithStringTypedReturnParams() {
    ...
    arrayStringProperty.setItems(
        new ai.platon.cdt.protocol.definition.types.type.object.properties.array.items
            .StringArrayItem());
