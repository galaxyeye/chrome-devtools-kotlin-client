...
import ai.platon.cdt.protocol.events.network.DataReceived;
import ai.platon.cdt.protocol.events.network.EventSourceMessageReceived;
import ai.platon.cdt.protocol.events.network.LoadingFailed;
import ai.platon.cdt.protocol.events.network.LoadingFinished;
import ai.platon.cdt.protocol.events.network.RequestIntercepted;
import ai.platon.cdt.protocol.events.network.RequestServedFromCache;
import ai.platon.cdt.protocol.events.network.RequestWillBeSent;
import ai.platon.cdt.protocol.events.network.RequestWillBeSentExtraInfo;
import ai.platon.cdt.protocol.events.network.ResourceChangedPriority;
import ai.platon.cdt.protocol.events.network.ResponseReceived;
import ai.platon.cdt.protocol.events.network.ResponseReceivedExtraInfo;
import ai.platon.cdt.protocol.events.network.SignedExchangeReceived;
import ai.platon.cdt.protocol.events.network.TrustTokenOperationDone;
import ai.platon.cdt.protocol.events.network.WebSocketClosed;
import ai.platon.cdt.protocol.events.network.WebSocketCreated;
import ai.platon.cdt.protocol.events.network.WebSocketFrameError;
import ai.platon.cdt.protocol.events.network.WebSocketFrameReceived;
import ai.platon.cdt.protocol.events.network.WebSocketFrameSent;
import ai.platon.cdt.protocol.events.network.WebSocketHandshakeResponseReceived;
import ai.platon.cdt.protocol.events.network.WebSocketWillSendHandshakeRequest;
import ai.platon.cdt.protocol.events.network.WebTransportClosed;
import ai.platon.cdt.protocol.events.network.WebTransportConnectionEstablished;
import ai.platon.cdt.protocol.events.network.WebTransportCreated;
...
import ai.platon.cdt.protocol.types.network.AuthChallengeResponse;
import ai.platon.cdt.protocol.types.network.ConnectionType;
import ai.platon.cdt.protocol.types.network.ContentEncoding;
import ai.platon.cdt.protocol.types.network.Cookie;
import ai.platon.cdt.protocol.types.network.CookieParam;
import ai.platon.cdt.protocol.types.network.CookiePriority;
import ai.platon.cdt.protocol.types.network.CookieSameSite;
import ai.platon.cdt.protocol.types.network.CookieSourceScheme;
import ai.platon.cdt.protocol.types.network.ErrorReason;
import ai.platon.cdt.protocol.types.network.LoadNetworkResourceOptions;
import ai.platon.cdt.protocol.types.network.LoadNetworkResourcePageResult;
import ai.platon.cdt.protocol.types.network.RequestPattern;
import ai.platon.cdt.protocol.types.network.ResponseBody;
import ai.platon.cdt.protocol.types.network.ResponseBodyForInterception;
import ai.platon.cdt.protocol.types.network.SecurityIsolationStatus;
