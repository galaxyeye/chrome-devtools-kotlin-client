...
import ai.platon.cdt.kt.serialization.protocol.events.css.ComputedStyleUpdated
import ai.platon.cdt.kt.serialization.protocol.events.css.FontsUpdated
import ai.platon.cdt.kt.serialization.protocol.events.css.MediaQueryResultChanged
import ai.platon.cdt.kt.serialization.protocol.events.css.StyleSheetAdded
import ai.platon.cdt.kt.serialization.protocol.events.css.StyleSheetChanged
import ai.platon.cdt.kt.serialization.protocol.events.css.StyleSheetRemoved
...
import ai.platon.cdt.kt.serialization.protocol.types.css.AnimatedStylesForNode
import ai.platon.cdt.kt.serialization.protocol.types.css.BackgroundColors
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSComputedStyleProperty
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSContainerQuery
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSLayerData
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSMedia
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSNavigation
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSProperty
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSRule
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSScope
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSStyle
import ai.platon.cdt.kt.serialization.protocol.types.css.CSSSupports
import ai.platon.cdt.kt.serialization.protocol.types.css.ComputedStyleForNode
import ai.platon.cdt.kt.serialization.protocol.types.css.InlineStylesForNode
import ai.platon.cdt.kt.serialization.protocol.types.css.MatchedStylesForNode
import ai.platon.cdt.kt.serialization.protocol.types.css.PlatformFontUsage
import ai.platon.cdt.kt.serialization.protocol.types.css.RuleUsage
import ai.platon.cdt.kt.serialization.protocol.types.css.SelectorList
import ai.platon.cdt.kt.serialization.protocol.types.css.SourceRange
import ai.platon.cdt.kt.serialization.protocol.types.css.StyleDeclarationEdit
import ai.platon.cdt.kt.serialization.protocol.types.css.TakeCoverageDelta
import ai.platon.cdt.kt.serialization.protocol.types.css.Value
...
interface CSS {
  ...
  suspend fun getEnvironmentVariables(): JsonObject?
