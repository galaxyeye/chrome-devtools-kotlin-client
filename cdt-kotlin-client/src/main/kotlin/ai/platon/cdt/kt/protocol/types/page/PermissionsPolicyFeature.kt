...
public enum class PermissionsPolicyFeature {
  ...
  LOCAL_FONTS,
  @JsonProperty("local-network")
  LOCAL_NETWORK,
  @JsonProperty("local-network-access")
  LOCAL_NETWORK_ACCESS,
  @JsonProperty("loopback-network")
  LOOPBACK_NETWORK,
  @JsonProperty("magnetometer")
  MAGNETOMETER,
  @JsonProperty("manual-text")
  MANUAL_TEXT,
