...
import ai.platon.cdt.kt.protocol.types.extensions.ExtensionInfo
import ai.platon.cdt.kt.protocol.types.extensions.StorageArea
import kotlin.Any
...
interface Extensions {
  ...
  @Returns("data")
  @ReturnTypeParameter(String::class, Any::class)
  suspend fun getStorageItems(@ParamName("id") id: String, @ParamName("storageArea") storageArea: StorageArea): Map<String, Any?> {
  ...
  suspend fun setStorageItems(
    @ParamName("id") id: String,
    @ParamName("storageArea") storageArea: StorageArea,
    @ParamName("values") values: Map<String, Any?>,
  )
}
