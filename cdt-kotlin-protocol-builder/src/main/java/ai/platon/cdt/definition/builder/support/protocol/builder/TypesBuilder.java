package ai.platon.cdt.definition.builder.support.protocol.builder;

/*-
 * #%L
 * cdt-java-protocol-builder
 * %%
 * Copyright (C) 2018 - 2026 browser4.io
 * %%
...
import static ai.platon.cdt.definition.builder.support.utils.StringUtils.*;

import ai.platon.cdt.definition.builder.support.java.builder.*;
import ai.platon.cdt.definition.builder.support.java.builder.support.CombinedBuilders;
import ai.platon.cdt.definition.builder.support.protocol.builder.support.DomainTypeResolver;
import ai.platon.cdt.definition.builder.support.protocol.builder.support.PropertyHandlerResult;
import ai.platon.cdt.definition.builder.support.protocol.builder.support.TypeBuildRequest;
...
public class TypesBuilder {
  ...
  protected static boolean isRefArrayItemType(
      ai.platon.cdt.protocol.definition.types.type.array.ArrayItem arrayItem) {
    return arrayItem
        instanceof ai.platon.cdt.protocol.definition.types.type.array.items.RefArrayItem;
  }
   ...
   * @param <T> Array item class type.
   */
  private static <T extends ai.platon.cdt.protocol.definition.types.type.array.ArrayItem>
