...
import ai.platon.cdt.kt.serialization.protocol.events.webmcp.ToolInvoked
import ai.platon.cdt.kt.serialization.protocol.events.webmcp.ToolResponded
import ai.platon.cdt.kt.serialization.protocol.events.webmcp.ToolsAdded
import ai.platon.cdt.kt.serialization.protocol.events.webmcp.ToolsRemoved
...
interface WebMCP {
  ...
  suspend fun invokeTool(
    ...
    @ParamName("input") input: JsonObject?,
  ): String
