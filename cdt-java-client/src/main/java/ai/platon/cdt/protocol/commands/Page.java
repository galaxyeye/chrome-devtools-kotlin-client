...
import ai.platon.cdt.protocol.events.page.BackForwardCacheNotUsed;
import ai.platon.cdt.protocol.events.page.CompilationCacheProduced;
import ai.platon.cdt.protocol.events.page.DocumentOpened;
import ai.platon.cdt.protocol.events.page.DomContentEventFired;
import ai.platon.cdt.protocol.events.page.DownloadProgress;
import ai.platon.cdt.protocol.events.page.DownloadWillBegin;
import ai.platon.cdt.protocol.events.page.FileChooserOpened;
import ai.platon.cdt.protocol.events.page.FrameAttached;
import ai.platon.cdt.protocol.events.page.FrameClearedScheduledNavigation;
import ai.platon.cdt.protocol.events.page.FrameDetached;
import ai.platon.cdt.protocol.events.page.FrameNavigated;
import ai.platon.cdt.protocol.events.page.FrameRequestedNavigation;
import ai.platon.cdt.protocol.events.page.FrameResized;
import ai.platon.cdt.protocol.events.page.FrameScheduledNavigation;
import ai.platon.cdt.protocol.events.page.FrameStartedLoading;
import ai.platon.cdt.protocol.events.page.FrameStoppedLoading;
import ai.platon.cdt.protocol.events.page.InterstitialHidden;
import ai.platon.cdt.protocol.events.page.InterstitialShown;
import ai.platon.cdt.protocol.events.page.JavascriptDialogClosed;
import ai.platon.cdt.protocol.events.page.JavascriptDialogOpening;
import ai.platon.cdt.protocol.events.page.LifecycleEvent;
import ai.platon.cdt.protocol.events.page.LoadEventFired;
import ai.platon.cdt.protocol.events.page.NavigatedWithinDocument;
import ai.platon.cdt.protocol.events.page.ScreencastFrame;
import ai.platon.cdt.protocol.events.page.ScreencastVisibilityChanged;
import ai.platon.cdt.protocol.events.page.WindowOpen;
...
import ai.platon.cdt.protocol.support.annotations.Optional;
...
import ai.platon.cdt.protocol.types.debugger.SearchMatch;
import ai.platon.cdt.protocol.types.page.AppManifest;
import ai.platon.cdt.protocol.types.page.CaptureScreenshotFormat;
import ai.platon.cdt.protocol.types.page.CaptureSnapshotFormat;
import ai.platon.cdt.protocol.types.page.CompilationCacheParams;
import ai.platon.cdt.protocol.types.page.FontFamilies;
import ai.platon.cdt.protocol.types.page.FontSizes;
import ai.platon.cdt.protocol.types.page.FrameResourceTree;
import ai.platon.cdt.protocol.types.page.FrameTree;
import ai.platon.cdt.protocol.types.page.InstallabilityError;
import ai.platon.cdt.protocol.types.page.LayoutMetrics;
import ai.platon.cdt.protocol.types.page.Navigate;
import ai.platon.cdt.protocol.types.page.NavigationHistory;
import ai.platon.cdt.protocol.types.page.PermissionsPolicyFeatureState;
import ai.platon.cdt.protocol.types.page.PrintToPDF;
import ai.platon.cdt.protocol.types.page.PrintToPDFTransferMode;
import ai.platon.cdt.protocol.types.page.ReferrerPolicy;
import ai.platon.cdt.protocol.types.page.ResourceContent;
import ai.platon.cdt.protocol.types.page.SetDownloadBehaviorBehavior;
import ai.platon.cdt.protocol.types.page.SetWebLifecycleStateState;
import ai.platon.cdt.protocol.types.page.StartScreencastFormat;
import ai.platon.cdt.protocol.types.page.TransitionType;
import ai.platon.cdt.protocol.types.page.Viewport;
