...
import ai.platon.cdt.protocol.events.fetch.AuthRequired;
import ai.platon.cdt.protocol.events.fetch.RequestPaused;
...
import ai.platon.cdt.protocol.types.fetch.AuthChallengeResponse;
import ai.platon.cdt.protocol.types.fetch.HeaderEntry;
import ai.platon.cdt.protocol.types.fetch.RequestPattern;
import ai.platon.cdt.protocol.types.fetch.ResponseBody;
