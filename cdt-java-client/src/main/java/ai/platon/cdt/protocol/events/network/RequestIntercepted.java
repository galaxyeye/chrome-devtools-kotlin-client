package ai.platon.cdt.protocol.events.network;
...
import ai.platon.cdt.protocol.types.network.AuthChallenge;
import ai.platon.cdt.protocol.types.network.ErrorReason;
import ai.platon.cdt.protocol.types.network.Request;
import ai.platon.cdt.protocol.types.network.ResourceType;
