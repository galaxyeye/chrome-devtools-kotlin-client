...
import ai.platon.cdt.protocol.events.tracing.BufferUsage;
import ai.platon.cdt.protocol.events.tracing.DataCollected;
import ai.platon.cdt.protocol.events.tracing.TracingComplete;
...
import ai.platon.cdt.protocol.types.tracing.MemoryDumpLevelOfDetail;
import ai.platon.cdt.protocol.types.tracing.RequestMemoryDump;
import ai.platon.cdt.protocol.types.tracing.StartTransferMode;
import ai.platon.cdt.protocol.types.tracing.StreamCompression;
import ai.platon.cdt.protocol.types.tracing.StreamFormat;
import ai.platon.cdt.protocol.types.tracing.TraceConfig;
import ai.platon.cdt.protocol.types.tracing.TracingBackend;
