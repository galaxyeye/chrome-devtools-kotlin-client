...
public enum class BackForwardCacheNotRestoredReason {
  ...
  @JsonProperty("ForwardCacheDisabled")
  ...
  SHARED_WORKER,
  @JsonProperty("SharedWorkerMessage")
  SHARED_WORKER_MESSAGE,
  @JsonProperty("SharedWorkerWithNoActiveClient")
  SHARED_WORKER_WITH_NO_ACTIVE_CLIENT,
  @JsonProperty("WebLocks")
  WEB_LOCKS,
  @JsonProperty("WebLocksContention")
  WEB_LOCKS_CONTENTION,
  @JsonProperty("WebHID")
  WEB_HID,
  @JsonProperty("WebBluetooth")
  WEB_BLUETOOTH,
  ...
  @JsonProperty("WebRTCUsedWithCCNS")
  WEB_RTC_USED_WITH_CCNS,
  @JsonProperty("WebTransportUsedWithCCNS")
  WEB_TRANSPORT_USED_WITH_CCNS,
  @JsonProperty("WebSocketUsedWithCCNS")
  ...
  @JsonProperty("EmbedderExtensionFrame")
