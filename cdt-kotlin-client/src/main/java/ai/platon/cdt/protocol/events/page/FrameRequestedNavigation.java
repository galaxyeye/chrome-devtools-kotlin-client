package ai.platon.cdt.protocol.events.page;
...
import ai.platon.cdt.protocol.types.page.ClientNavigationDisposition;
import ai.platon.cdt.protocol.types.page.ClientNavigationReason;
