...
import ai.platon.cdt.kt.serialization.protocol.events.applicationcache.ApplicationCacheStatusUpdated
import ai.platon.cdt.kt.serialization.protocol.events.applicationcache.NetworkStateUpdated
...
import ai.platon.cdt.kt.serialization.protocol.types.applicationcache.FrameWithManifest
...
interface ApplicationCache {
  ...
  suspend fun getApplicationCacheForFrame(@ParamName("frameId") frameId: String): ai.platon.cdt.kt.serialization.protocol.types.applicationcache.ApplicationCache
